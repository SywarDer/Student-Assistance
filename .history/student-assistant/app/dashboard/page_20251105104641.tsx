...
export default function Dashboard() {
  ...
  `;
    ...
    const query = `
      mutation CreateSubject($title: String!, $description: String!) {
        createSubject(title: $title, description: $description) {
          id
          title
          description
        }
    ...
    try {
      ...
      console.log("✅ New Subject Created:", data.data.createSubject);
    } catch (err) {
      console.error("❌ Error creating subject:", err);
        ...
        const data = await res.json();
        console.log("New Subject:", data.data.createSubject);
    };
                    ...
                    <div className="grid gap-4">
                        ...
                        <div className="grid gap-2 ">
                            ...
                            <div className="grid grid-cols-3 items-center gap-4">
                                ...
                                <Input
                                    id="maxWidth"
                                    defaultValue="This is a subject about Mathematics.."
                                    className="col-span-2 h-8"
                                    value={description}
                                    onChange={(e)=>setTitle(e.target.value)}
                                />
