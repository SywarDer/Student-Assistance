        ...
        <div className="m-8 space-y-8">
            ...
            <Popover>
                <PopoverTrigger asChild>
                    <Button variant="outline" className="cursor-pointer text-2xl" style={{backgroundColor:"var(--ring)"}}>Add Subject <PlusSquare /></Button>
                </PopoverTrigger>
            ...
            <table className="min-w-full border">
                <caption className="text-left font-medium p-4"><PlusSquare/></caption>
