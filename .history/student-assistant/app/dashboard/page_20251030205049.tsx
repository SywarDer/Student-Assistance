...
import { Dialog, DialogTrigger, DialogContent, DialogTitle, DialogDescription, DialogClose,DialogHeader } from "@radix-ui/react-dialog";
    ...
    return (
        ...
        <div className="m-8 space-y-8">
            ...
            <table className="min-w-full border">
                <caption className="text-left text-xl cursor-pointer"><PlusSquare /></caption>
